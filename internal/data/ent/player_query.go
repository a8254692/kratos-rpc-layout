...
func (pq *PlayerQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *PlayerQuery) FirstIDX(ctx context.Context) int64 {
...
func (pq *PlayerQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *PlayerQuery) OnlyIDX(ctx context.Context) int64 {
...
func (pq *PlayerQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (pq *PlayerQuery) IDsX(ctx context.Context) []int64 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PlayerQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(player.Table, player.Columns, sqlgraph.NewFieldSpec(player.FieldID, field.TypeInt64))
	_spec.From = pq.sql
